        ...
        <div class="mb-8">
            <div class="rounded-md bg-green-50 p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-green-800">{!! $message['message'] !!}</p>
                    </div>
        ...
        <div class="mb-8">
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">{!! $message['message'] !!}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            <div class="bg-red-50 border-l-4 border-red-400 p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700">{!! $message['message'] !!}</p>
                    </div>
                </div>
            </div>
        </div>
