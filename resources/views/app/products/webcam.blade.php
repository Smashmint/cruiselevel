        ...
        <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div class="lg:col-span-4 lg:row-end-1">
                <div class="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg bg-gray-100">
                    <img src="https://resource.logitech.com/w_797,c_limit,q_auto,f_auto,dpr_2.0/d_transparent.gif/content/dam/logitech/en/products/webcams/streamcam/streamcam-feature2.png?v=1"
                        alt="Logitech Stream Cam" class="object-cover object-center">
                </div>
            </div>
            ...
            <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                <div class="flex flex-col-reverse">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Logitech Stream Cam</h1>
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    ...
                    <div class="prose prose-sm mt-4 text-gray-500">
                        <ul role="list">
                            ...
                            <li>Connects with USB-C</li>

                            <li>Works with Windows and MacOS</li>

                            <li>Live led indicator</li>

                            <li>Built-in microphone</li>

                            <li>Compatible with Slack, Microsoft Teams, Google Meet and Zoom</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div>
                          ...
                          -->
                            ...
                            <div class="prose prose-sm pb-6" id="disclosure-1">
                                <ul role="list">
                                    <li>Logitech Stream Cam Black with desk clip</li>
