        ...
        <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div class="lg:col-span-4 lg:row-end-1">
                <div class="aspect-w-4 aspect-h-3 overflow-hidden rounded-lg bg-gray-100">
                    <img src="https://d33p2k2w4zpozf.cloudfront.net/media/catalog/product/cache/4832662449f27945c40903385bb67a42/w/e/web-pic_mmx300-facelift2016_16-11_perspective_v1_1.jpg"
                        alt="Beyerdynamic MMX 300" class="object-cover object-center">
                </div>
            </div>
            ...
            <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                <div class="flex flex-col-reverse">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Beyerdynamic MMX 300</h1>
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    ...
                    <div class="prose prose-sm mt-4 text-gray-500">
                        <ul role="list">
                            <li>Wired headphone which always works</li>

                            <li>Flippable microphone with suberb recording quality</li>

                            <li>Unbreakable audio cable</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div>
                          ...
                          -->
                            ...
                            <div class="prose prose-sm pb-6" id="disclosure-1">
                                <ul role="list">
                                    <li>Beyerdynamic MMX 300</li>
                                    <li>Hardshell carry case</li>
                                    <li>2.5m cable with 3.5mm audio and microphone connector</li>
                                    <li>6.35mm jack adapter</li>
                                </ul>
                            </div>
                        </div>
                    </div>
