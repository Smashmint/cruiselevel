        ...
        <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div class="lg:col-span-4 lg:row-end-1">
                <div class="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg bg-gray-100">
                    <img src="https://i.pcmag.com/imagery/reviews/06QHTgKw0vaD9RsBZTNJWsz-2..v1590793518.jpg"
                        alt="Dell 25 inch monitor" class="object-cover object-center">
                </div>
            </div>
            ...
            <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                <div class="flex flex-col-reverse">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Dell UltraSharp 25" monitor</h1>
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    ...
                    <div class="prose prose-sm mt-4 text-gray-500">
                        <ul role="list">
                            <li>25 inch screen with 2560x1440 resolution</li>

                            <li>Adjustable in height and tiltable</li>

                            <li>Charge with your laptop with 90W power delivery over USB-C</li>

                            <li>1x USB-C, 2x HDMI, 2x DisplayPort and 2x USB 3</li>

                            <li>100mm VESA mount</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div>
                          ...
                          -->
                            ...
                            <div class="prose prose-sm pb-6" id="disclosure-1">
                                <ul role="list">
                                    <li>Dell UltraSharp U2520D</li>
                                    <li>1.4M power cable</li>
