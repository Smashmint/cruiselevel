        ...
        <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div class="lg:col-span-4 lg:row-end-1">
                <div class="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg bg-gray-100">
                    <img src="https://cdn0.vox-cdn.com/hermano/verge/product/image/9938/DSCF8639-2.jpg"
                        alt="Sennheiser Momentum 4" class="object-cover object-center">
                </div>
            </div>
            ...
            <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                <div class="flex flex-col-reverse">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Sennheiser Momentum 4</h1>
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    ...
                    <div class="prose prose-sm mt-4 text-gray-500">
                        <ul role="list">
                            ...
                            <li>Wireless Bluetooth 5.2 connection</li>

                            <li>60 hours battery life, fully charged in 2 hours</li>
                        ...
                        <div>
                          ...
                          -->
                            ...
                            <div class="prose prose-sm pb-6" id="disclosure-1">
                                <ul role="list">
                                    <li>MOMENTUM 4 headphone</li>
                                    <li>Carry case</li>
                                    <li>Audio cable 3.5mm and 2.5mm jacks</li>
