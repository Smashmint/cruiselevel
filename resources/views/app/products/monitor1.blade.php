        ...
        <div class="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
            ...
            <div class="lg:col-span-4 lg:row-end-1">
                <div class="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg bg-gray-100">
                    <img src="https://www.lg.com/nl/images/monitor/md07554693/Features/mnt-dualup-ergo-28mq780-01-2-lg-dualup-monitor-ergo-mobile.jpg"
                        alt="LG DualUp Monitor" class="object-cover object-center">
                </div>
            </div>
            ...
            <div class="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                <div class="flex flex-col-reverse">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">LG DualUp 28" monitor</h1>
                ...
                <div class="mt-8 border-t border-gray-200 pt-8">
                    ...
                    <div class="prose prose-sm mt-4 text-gray-500">
                        <ul role="list">
                            <li>28 inch LCD screen with 2560x2880 resolution</li>

                            <li>Adjustable in height and tiltable</li>

                            <li>Charge with your laptop with 90W USB-C power delivery</li>

                            <li>1x USB-C, 2x HDMI, 1x DisplayPort and 2x USB 3</li>
